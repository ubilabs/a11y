...
function App() {
  return (
    <>
      <h1>Accessibility Done Wrong</h1>
      ...
      <section>
        <header>
          ...
          <p>
            ...
            contrast ratio of at least 3:1 between its pixels in focused and
            unfocused states, and ensures a contrast ratio of at least 3:1
      ...
      <section>
        <header>
          ...
          <p>
            ...
            should not require the use of a mouse or other pointing device.
          </p>
        </header>
